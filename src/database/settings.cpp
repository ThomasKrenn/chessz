...
QString Settings::dataPath()
{
    if(m_dataPath.isNull())
    {
       ...
       QString m_dataPath = QDir::toNativeSeparators(QCoreApplication::applicationDirPath());
       m_dataPath.append(QDir::separator());
       m_dataPath.append("data");
...
QString Settings::portableIniPath()
{
   ...
   QString portableIni = appDir + QDir::separator() + "chessz.ini";
   return portableIni;
}
