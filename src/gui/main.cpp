...
/*
  learn.microsoft.com/en-us/cpp/preprocessor/predefined-macros?view=msvc-170
*/
// #ifdef _WINDOWS
// #ifdef _DEBUG
// #include <vld.h>
...
// #endif
    ...
    app.setApplicationName("chessz");
    app.setOrganizationName("chessz");
    app.setOrganizationDomain("https://thomaskrenn.github.io/");
