    ...
    m_posDecoration(QStyleOptionViewItem::Left)
{
    ...
    connect(&m_PieceDragTimer, SIGNAL(timeout()), this, SLOT(SlotDragTimer()));
    m_PieceDragTimer.setSingleShot(true);
}
